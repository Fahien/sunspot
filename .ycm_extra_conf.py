...
flags = [
    ...
    # prepend -isystem to each individual path and append them all to the list
    # of flags you return from your FlagsForFile function in your .ycm_extra_conf.py file.
